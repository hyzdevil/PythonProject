def str_methods():
    # string = "hello world\nasdfg"
    string = "hello,world"
    # print(string.zfill(8)) # 若字符串总长度小于所填参数，则在字符串的左侧填充0；否则不改变字符串
    ...
    # print(string.rpartition("o")) # 将字符串以给定字符分割，从右边数第一个，返回一个列表
    # print(string.ljust(8,"0")) # 若字符串总长度小于所填参数，则在字符串的右侧填充给定字符，默认为空格；
    # print(string.rjust(8,"0")) # 若字符串总长度小于所填参数，则在字符串的左侧填充给定字符，默认为空格；
    # print(string.rindex("s")) # 返回右侧数第一个匹配的字符串的索引，没有找到则报错
    # print(string.rfind("l")) # 返回右侧数第一个匹配的字符串的索引，没有找到则返回-1
    # print(string.replace("o","s")) # 替换字符串，
    print(string.partition("sw")) # 返回以给定字符串分割的元组，(分隔符之前的字符串, 分隔符本身, 分隔符之后的字符串)
